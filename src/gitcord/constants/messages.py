...
# Error messages
ERR_PERMISSION_DENIED = "You need the required permission to use this command."
...
HELP_FOOTER = "GitCord - Discord bot for GitOps based server structure"

# UI button labels
DELETE_EXTRA_CHANNELS_LABEL = "Delete Extra Channels" 